...
class Config:
    ...
    MAX_CARS = 100  # Nastaveno na 5000 pro plné testování
    ...
    # IDM parameters
    MIN_GAP = 0.5  # Minimum gap between cars
    MAX_ACCELERATION = 3.0  # Maximum acceleration in m/s²
    MAX_DECELERATION = 3.5  # Maximum deceleration in m/s²
    DELTA = 4
    DESIRED_SPEED = 13.89  # 50km/h
    REACT_TIME = 0.5  # Driver's react time (time headway)
    ...
    # Silent Mode
    SILENT = False  # Set to True to run simulation silently
